...
Serializer<GcreatePostReq> _$gcreatePostReqSerializer =
    new _$GcreatePostReqSerializer();
...
class _$GcreatePostReqSerializer
  ...
  GcreatePostReq deserialize(
      ...
      {FullType specifiedType = FullType.unspecified}) {
    final result = new GcreatePostReqBuilder();
...
class _$GcreatePostReq extends GcreatePostReq {
  ...
  factory _$GcreatePostReq([void Function(GcreatePostReqBuilder)? updates]) =>
      (new GcreatePostReqBuilder()..update(updates))._build();
  ...
  _$GcreatePostReq._(
      ...
      this.context})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(vars, r'GcreatePostReq', 'vars');
  ...
  @override
  GcreatePostReqBuilder toBuilder() =>
      new GcreatePostReqBuilder()..replace(this);
...
class GcreatePostReqBuilder
  ...
  _i3.GcreatePostVarsBuilder get vars =>
      _$this._vars ??= new _i3.GcreatePostVarsBuilder();
  ...
  _i2.GcreatePostDataBuilder get optimisticResponse =>
      _$this._optimisticResponse ??= new _i2.GcreatePostDataBuilder();
